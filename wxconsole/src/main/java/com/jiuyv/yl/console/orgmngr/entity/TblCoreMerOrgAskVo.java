...
public class TblCoreMerOrgAskVo {
	...
	private String checkStatueZh;
	private String eraseFlagZh;
	private String lastUptOrgName;
	public TblCoreMerOrgAskVo()
	{
	...
	public void setAskBatchNo(String askBatchNo)
	{
		this.askBatchNo = askBatchNo;
	}
	public String getAskBatchNo()
	{
		return this.askBatchNo;
	}
	...
	public String getCheckStatueZh() {
		return checkStatueZh;
	}

	public void setCheckStatueZh(String checkStatueZh) {
		this.checkStatueZh = checkStatueZh;
	}

	public String getEraseFlagZh() {
		return eraseFlagZh;
	}

	public void setEraseFlagZh(String eraseFlagZh) {
		this.eraseFlagZh = eraseFlagZh;
	}
	...
	public String getLastUptOrgName() {
		return lastUptOrgName;
	}

	public void setLastUptOrgName(String lastUptOrgName) {
		this.lastUptOrgName = lastUptOrgName;
	}
