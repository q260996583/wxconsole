...
public class XLSSheetTemplate {
	...
	private Boolean drawSubtitle = true;
	...
	/**
	 * @param drawTitle the drawTitle to set
	 */
	...
	/**
	 * @param drawSubtitle the drawSubtitle to set
	 */
	public void setDrawSubtitle(Boolean drawSubtitle) {
	...
	/**
	 * @param drawHead the drawHead to set
	 */
