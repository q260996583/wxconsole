...
<script type="text/javascript" src="pagejs/console/business/tidmngr/unionPayTidBackup.js"></script>
</head>
<body>
...
<table class="qtable" width="100%"  cellspacing="1" cellpadding="1" >
	...
	<tr>
		...
		<td class="#ffffff"  align="left" colspan="3" ><s:property value="result"></s:property></td>
	</tr>
	<tr>
