...
<script type="text/javascript"
	src="pagejs/console/business/report/stats/bankBrandReport.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				...
				<td class="qlabel"><font color="red">*</font>报表类型</td>
					<td class="qinput"><select  id="reportType" name="reportType">
							...
							<option value="FFT_BANK_BRAND">申鑫品牌服务费日报表</option>
							<option value="FIRSTCHN_BANK_BRAND">一级服务商品牌服务费日报表</option>
							<option value="FFT_BANK_BRAND_SUM">申鑫品牌服务费汇总表</option>							
					</select></td>
				...
				<tr id="channelTr" style="display: none">
