...
<script type="text/javascript"
	src="pagejs/console/business/report/stats/fftSecFeeReport.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
	...
	<div>
		<form id="queryForm">
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				<tr>
				<td class="qlabel" ><font color="red">*</font>查询日期</td>
					<td class="qinput" colspan="5"><input id="monthStr" name="monthStr" /></td>
				</tr>
