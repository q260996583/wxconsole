...
<script type="text/javascript"
	src="pagejs/console/business/report/clear/fftSecFeeDayRpt.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				...
				<td class="qlabel"><font color="red">*</font>报表类型</td>
					<td class="qinput"><select  id="reportType" name="reportType">
							...
							<option value="FFT_SEC_FEE_DETAIL_DAY">手续费统计表(收单日报)</option>
							<option value="FFT_SEC_FEE_DETAIL_CHANNEL">手续费汇总表(收单日报)</option>
					</select></td>
