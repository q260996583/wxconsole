...
<script type="text/javascript" src="pagejs/console/business/report/stats/posMccDevelopActiveStatsReport.js"></script>
<script type="text/javascript">
$(document).ready(function() {
	var height = document.body.offsetHeight;
	var othHeight = $('#queryDiv').outerHeight();
	$('#printFrame').css({'height': height - othHeight});
	// 隐藏打印功能
	$('#printbt').click(function() {
		
		/* 
		if (window.frames['printFrame'] == null) {
       document.getElementById('printFrame').focus();
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				<tr><td class="qlabel"><font color="red">*</font>报表类型</td>
					<td class="qinput">
						<select  id="reportType" name="reportType">
							...
							<option value="POS_DEVELOP_STATS">POS业务发展情况统计表</option>
							<option value="POS_ACTIVE_STATS">POS业务活跃情况统计表</option>						
						</select>
					</td>
				...
				<tr>
					<td bgcolor="#ffffff" colspan="8" align="center">
						...
						<!-- <input class="bt" id="printbt" value="打印" type="button" /> -->
