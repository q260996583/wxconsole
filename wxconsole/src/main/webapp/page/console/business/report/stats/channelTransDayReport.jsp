...
<script type="text/javascript"
	src="pagejs/console/business/report/stats/channelTransDayReport.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				...
				<td class="qlabel"><font color="red">*</font>报表类型</td>
					<td class="qinput"><select id="reportType"  name="reportType">
							...
							<option value="FIRSTCHN_TXN_DAY">一级服务商交易日报表（收单）</option>
							<option value="FIRSTCHN_TXN_DAY_IN_CARD">一级服务商交易日报表（收单-内卡）</option>
							<option value="FIRSTCHN_TXN_DAY_OUT_CARD">一级服务商交易日报表（收单-外卡）</option>							
					</select></td>
