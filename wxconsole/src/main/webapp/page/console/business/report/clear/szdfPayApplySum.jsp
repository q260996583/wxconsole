...
<script type="text/javascript"
	src="pagejs/console/business/report/clear/szdfPayApplySum.js"></script>
<script type="text/javascript">
	$(document)
			.ready(
					function() {
...
<%-- 					<td class="qlabel"><FONT color=red>&nbsp;*</FONT>所属银行</td>
					<td class="qinput">
						<select id="bankAccntId" comparison="eq" name="bankAccntId"></select>
					</td> --%>
...
<!-- 						<input type="button" class="bt" id="downFile" value="导出文件XXX" />
