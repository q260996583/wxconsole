...
<script type="text/javascript"
	src="pagejs/console/business/report/clear/checkResultDetail.js"></script>
</head>
<body>
							...
							<table class="ftable" cellpadding="1" cellspacing="1"
								...
								<tbody>
									<tr>
										...
										<td><INPUT id=stlmDate  name=stlmDate ></td>
									</tr>
									<tr>
										<td class="flabel">机构名称:</td>
										<td><INPUT id=bankName  name=bankName ></td>
									</tr>
									<tr>
										<td class="flabel">系统流水号:</td>
										<td><INPUT id=transSeq  name=transSeq ></td>
									</tr>
									<tr>
