...
<script type="text/javascript"
	src="pagejs/console/business/report/clear/bankBackClearDetail.js"></script>
<script type="text/javascript">
	$(document)
			.ready(
					function() {
		...
		<form id="queryForm">
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				<tr>
					...
					<td class="qlabel">退款类型</td>
					<td class="qinput"><select id="backCode" comparison="eq"
						name="backCode"></select></td>
				</tr>
