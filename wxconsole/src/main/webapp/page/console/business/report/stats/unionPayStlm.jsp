...
<script type="text/javascript"
	src="pagejs/console/business/report/stats/unionPayStlm.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				...
				<td class="qlabel"><font color="red">*</font>报表类型</td>
					<td class="qinput"><select  id="reportType" name="reportType">
							...
							<option value="UNION_PAY_STLM_RPT">银联代付清算明细表</option>
							<option value="UNION_PAY_STLM_RETURN_RPT">银联代付退汇明细表</option>
					</select></td>
