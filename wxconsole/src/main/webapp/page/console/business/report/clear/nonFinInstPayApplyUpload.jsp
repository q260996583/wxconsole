...
<!-- 						<input type="button" class="bt" id="downFile" value="导出文件" />
 -->						<input type="button" class="bt" id="downFileExl" value="导出Execl" />
						<input type="button" class="bt" id="insertForm" name="insertForm" value="文件发送" onclick="submitSaveForm_input()" /> 
		...
		<table class="ftable" cellpadding="1" cellspacing="1" width="100%">
			<TBODY>
				<TR>
					...
					<TD class="finput"><input id="upLoadfile" type="file" name="upLoadfile" /></TD>
				</TR>
			</TBODY>
		</table>
	</form>
