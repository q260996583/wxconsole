...
<script type="text/javascript"
	src="pagejs/console/business/report/clear/scoreOrgReturn.js"></script>
<script type="text/javascript">
	$(document)
			.ready(
					function() {
		...
		<form id="queryForm">
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				<tr>
					...
					<td class="qinput"><select id="mark" comparison="eq" name="mark"></select></td>
					
				</tr>

				<tr>
					<td class="qlabel"><FONT color=red>&nbsp;*</FONT>积分机构</td>
					<td class="qinput">
						<INPUT style="display: none;" id="bankId" name="bankId" comparison="eq">
						<INPUT id="qbankName" name="qbankName" readonly="readonly" value="大丰收">
					</td>
				...
				<tr>
					<td bgcolor="#ffffff" colspan="6" align="center">
						...
						<input type="button" class="bt" id="downYLFile" value="生成退款文件" />
