...
<script type="text/javascript"
	src="pagejs/console/business/report/clear/payApplyInner.js"></script>
<script type="text/javascript">
	$(document)
			.ready(
					function() {
		...
		<form id="queryForm">
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				<tr>
					...
					<td class="qinput"><input id="dateStart" name="dateStart" />
					</td>
				...
				<tr>
					...
					<input type="button" class="bt" id="downFileExl" value="导出Execl" /></td>
				</tr>
