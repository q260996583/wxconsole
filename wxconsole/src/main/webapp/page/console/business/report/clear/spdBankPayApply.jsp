...
<script type="text/javascript"
	src="pagejs/console/business/report/clear/spdBankPayApply.js"></script>
<script type="text/javascript">
	$(document)
			.ready(
					function() {
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				...
				<tr>
					<td bgcolor="#ffffff" colspan="6" align="center">
						...
						<input type="button"  id="downFileUnionPay" value="银联代付转浦发" />
						<input type="button"  id="downFileSzdf" value="深圳快付通转浦发" />
					</td>
				</tr>
