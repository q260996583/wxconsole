...
<script type="text/javascript"
	src="pagejs/console/business/report/clear/cupsRoundSumReport.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
	...
	<div>
		<form id="queryForm">
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				...
				<tr>
					<td class="qlabel">差错类型</td>
					<td class="qinput"><select id="errType" name="errType"></select>
					</td>
					<td></td>
					<td></td>
				</tr>
				<tr>
					<td bgcolor="#ffffff" colspan="6" align="center"><input
						...
						class="bt" value="重置" type="reset" /> <input type="button"
						class="bt" id="downFileExl" value="导出Execl" /></td>
				</tr>
			</table>
		</form>
	</div>
