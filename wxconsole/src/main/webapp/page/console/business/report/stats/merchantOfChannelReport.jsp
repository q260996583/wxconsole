...
<script type="text/javascript"
	src="pagejs/console/business/report/stats/merchantOfChannelReport.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
		...
		<form id="queryForm">
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				...
				<td class="qlabel"><font color="red">*</font>服务商名称</td>
					<td class="qinput">	<INPUT style="display: none;" id="channelCode" name="channelCode" comparison="eq">
						<INPUT id="channelName" name="channelName" readonly="readonly" comparison="eq"></td>
