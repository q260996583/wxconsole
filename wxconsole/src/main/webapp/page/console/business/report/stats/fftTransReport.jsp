...
<script type="text/javascript"
	src="pagejs/console/business/report/stats/fftTransReport.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				...
				<td class="qlabel"><font color="red">*</font>报表类型</td>
					<td class="qinput"><select id="reportType" name="reportType">
							...
							<option value="FFT_TXN_SUMM">交易汇总表</option>
							<option value="FFT_TXN_SUMM_IN_CARD">交易汇总表(内卡)</option>
							<option value="FFT_TXN_SUMM_OUT_CARD">交易汇总表(外卡)</option>
					</select></td>
