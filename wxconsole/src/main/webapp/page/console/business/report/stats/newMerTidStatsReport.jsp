...
<script type="text/javascript"
	src="pagejs/console/business/report/stats/newMerTidStatsReport.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				<tr><td class="qlabel"><font color="red">*</font>报表类型</td>
					<td class="qinput"><select  id="reportType" name="reportType">
							...
							<option value="MER_ADD_STATS">新增商户统计表</option>
							<option value="TID_ADD_STATS">新增终端统计表</option>						
					</select></td>
