...
<script type="text/javascript"
	src="pagejs/console/business/report/stats/channelPNRTransDayReport.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
	...
	<div>
		<form id="queryForm">
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				<tr>
					<td class="qlabel"><FONT color=red>&nbsp;*</FONT>服务商名称</td>
					<td class="qinput">
					<INPUT style="display: none;" id="channelCode" name="channelCode" comparison="eq" value="999999999037000">
						<INPUT id="channelName" name="channelName" readonly="readonly" comparison="eq" value="上海汇付科技有限公司">
						</td>
