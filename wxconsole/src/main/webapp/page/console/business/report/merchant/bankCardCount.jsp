...
<script type="text/javascript"
	src="pagejs/console/business/report/merchant/bankCardCount.js"></script>
<script type="text/javascript">
	$(document).ready(
		function() {
			$('#printbt').click(
				...
				<td class="qlabel"><font color="red">*</font>报表类型</td>
					<td class="qinput">
						<select id="reportType" name="reportType">
								...
								<option value="FFT_TRANS_COUNT">收单业务量统计报表</option>
								<option value="FFT_MERCHANT_COUNT">商户数量统计报表</option>
						</select>
					</td>
