...
<!-- 商户出账 -->
<div id="amDiv" style="display: none;">
<!-- 查询条件 -->
<div id="am_queryCondition">
	<form id="am_queryForm" name="queryForm" action="#" method="post">
		<input type="hidden" name="applyState" value="01" qtype="string" comparison="eq" id="at_applyState"/>
		<input type="hidden" name="seqNo" id="am_seqNo" class="param" />
		<input type="hidden" name="version" id="am_version" />
		<ul class="qry-ul">
			<li><label>商户号</label><input id="am_q_mid" name="mid" type="text"  qtype="string" comparison="like" /></li>
			<li><label>商户名称</label><input id="am_q_merName" name="merName" type="text"  qtype="string" comparison="like" /></li>
			<li><input class='bt' id="am_queryBtn" value="查询" type="button"/></li>
			<li><input value="重置" class='bt' type="reset" /></li>
		</ul>
	</form>
</div>
...
<!-- 查询条件 -->
<div id="amt_queryCondition">
	<form id="amt_queryForm" name="queryForm" action="#" method="post">
		<input type="hidden" name="applyState" value="05" qtype="string" comparison="eq" id="amt_applyState"/>
		<input type="hidden" name="seqNo" id="amt_seqNo" class="param" />
		<input type="hidden" name="version" id="amt_version" />
		<ul class="qry-ul">
			<li><label>商户号</label><input id="amt_q_mid" name="mid" type="text"  qtype="string" comparison="like" /></li>
			<li><label>商户名称</label><input id="amt_q_merName" name="merName" type="text"  qtype="string" comparison="like" /></li>
			<li><input class='bt' id="amt_queryBtn" value="查询" type="button"/></li>
			<li><input value="重置" class='bt' type="reset" /></li>
		</ul>
	</form>
</div>
<!-- 列表 -->
<div id="amt_table"></div>
</div>

<!-- 全部出款 -->
<div id="afDiv" style="display: none;">
<form id="afForm" action="#">
...
<tr>
    ...
    <td class="fcontent"><input class="cdnInput" id="af_seqNo" name="seqNo" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">申请表编号</td>
    <td class="fcontent"><input class="cdnInput" id="af_payBillNo" name="payBillNo" type="text" readonly="readonly"/></td>
</tr>
<tr>
    <td class="flabel">开始日期</td>
    <td class="fcontent"><input class="cdnInput" id="af_bgnSday" name="bgnSday" type="text" xtype="date" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">结束日期</td>
    <td class="fcontent"><input class="cdnInput" id="af_endSday" name="endSday" type="text" xtype="date" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">支付机构号</td>
    <td class="fcontent"><input class="cdnInput" id="af_bankId" name="bankId" type="text" readonly="readonly" /></td>
</tr>
<tr>
	<td class="flabel">商户开户行</td>
	<td class="fcontent"><input class="cdnInput" id="af_accntBankStringListDesc" name="accntBankStringListDesc" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">申请类型</td>
    <td class="fcontent"><input class="cdnInput" id="af_payReqType" name="payReqTypeDesc" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">清算金额</td>
    <td class="fcontent"><input class="cdnInput" id="af_stlmAmt" name="stlmAmt" xtype="money" type="text" readonly="readonly"/></td>
</tr>
<tr>
    <td class="flabel">流量费</td>
    <td class="fcontent"><input class="cdnInput" id="af_flowFee" name="flowFee" xtype="money" type="text" readonly="readonly"/></td>
</tr>
<tr>
	<td class="flabel">强扣金额</td>
	<td class="fcontent"><input class="cdnInput" id="af_minusAmt" name="minusAmt" xtype="money" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">应付金额</td>
    <td class="fcontent"><input class="cdnInput" id="af_realAmt" name="realAmt" xtype="money" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel"><font color="red">*</font>实付金额</td>
    <td class="fcontent"><input class="cdnInput" id="af_bankRealAmt" name="bankRealAmt" xtype="money" type="text" /><div id="af_bankRealAmtTip"></div></td>
</tr>
<tr>
    <td class="flabel">清算笔数</td>
    <td class="fcontent"><input class="cdnInput" id="af_stlmCount" name="stlmCount" type="text" readonly="readonly" /></td>
</tr>

<tr>
    <td class="flabel">状态</td>
    <td class="fcontent"><input class="cdnInput" id="af_status" name="statusDesc" type="text" readonly="readonly" /></td>
</tr>
</table>
<table class="ftable" cellpadding="1" cellspacing="1" bgcolor="#8392a5" width="100%">
...
<tr>
    ...
    <td class="fcontent"><input class="cdnInput" id="af_bankAccntId" name="bankAccntId" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">行号</td>
    <td class="fcontent"><input class="cdnInput" id="af_bankNo" name="bankNo" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">账号</td>
    <td class="fcontent"><input class="cdnInput" id="af_accntNo" name="accntNo" type="text" readonly="readonly"/></td>
</tr>
<tr>
    <td class="flabel">支行名</td>
    <td class="fcontent"><input class="cdnInput" id="af_bankName" name="bankName" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">总行名</td>
    <td class="fcontent"><input class="cdnInput" id="af_bankTitle" name="bankTitle" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">账户名称</td>
    <td class="fcontent"><input class="cdnInput" id="af_accntName" name="accntName" type="text" readonly="readonly" /></td>
</tr>
</table>
...
<tr>
    ...
    <td class="fcontent"><input class="cdnInput" id="af_channelCode" name="channelCode" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">行号</td>
    <td class="fcontent"><input class="cdnInput" id="af_chnlBankNo" name="chnlBankNo" type="text" readonly="readonly"/></td>
</tr>
<tr>
    <td class="flabel">账号</td>
    <td class="fcontent"><input class="cdnInput" id="af_chnlAccntNo" name="chnlAccntNo" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">银行名称</td>
    <td class="fcontent"><input class="cdnInput" id="af_chnlBankName" name="chnlBankName" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">账户名</td>
    <td class="fcontent"><input class="cdnInput" id="af_chnlAccntName" name="chnlAccntName" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">持卡人证件号</td>
    <td class="fcontent"><input class="cdnInput" id="af_chnlPersonCardNo" name="chnlPersonCardNo" type="text" readonly="readonly" /></td>
</tr>
</table>
<table class="ftable" cellpadding="1" cellspacing="1" bgcolor="#8392a5" width="100%">
...
<tr>
    ...
    <td class="fcontent"><input class="cdnInput" id="af_audTime" name="audTime" type="text" xtype="time" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">审核人</td>
    <td class="fcontent"><input class="cdnInput" id="af_audUser" name="audUser" type="text" readonly="readonly"/></td>
</tr>
<tr>
    <td class="flabel">审核意见</td>
    <td class="fcontent"><textarea class="cdnInput" id="af_audRemark" name="audRemark" readonly="readonly" ></textarea></td>
</tr>
<tr>
    <td class="flabel">确认时间</td>
    <td class="fcontent"><input class="cdnInput" id="af_secAudTime" name="secAudTime" type="text" xtype="time" readonly="readonly"/></td>
</tr>
<tr>
    <td class="flabel">确认用户</td>
    <td class="fcontent"><input class="cdnInput" id="af_secAudUser" name="secAudUser" type="text" readonly="readonly" /></td>
</tr>
<tr>
    <td class="flabel">确认意见</td>
    <td class="fcontent"><textarea class="cdnInput" id="af_secAudRemark" name="secAudRemark" readonly="readonly"></textarea></td>
</tr>
</table>
</form>
</div>
...
var urls = {
	transdtl:'payApplyTransDetail.action',
	transdtlExcel:'payApplyTransDetailExcel.action',
	mchntdtl:'payApplyMchntDetail.action',
	mchntdtlExcel:'payApplyMchntDetailExcel.action',
	accntdtl:'payReqAccntDetail.action',
	accntdtlExcel:'payReqAccntDetailExcel.action',
	list:'payApplyPage.action',
	excel:'payApplyExcel.action',
	listAccBank:'listAccBank.action',
	payApplyRemoveMchnt:'payApplyRemoveByMchntList.action',
	payApplyAll:'payApplyAll.action',
	payAmtFailedMchnt:'payAmtFailedByMchntList.action',
	payAmtSuccessAll:'payAmtSuccessAll.action',
	loglist:'payApplyBalanceLogPage.action',
	loglistExcel:'payApplyBalanceLogPageExcel.action',
	logrel:'payApplyBalanceLogRelPage.action',
	logrelExcel:'payApplyBalanceLogRelPageExcel.action',
	settlerel:'payApplySettlePage.action',
	settlerelExcel:'payApplySettlePageExcel.action',
	settleAdjust:'payApplyFindSettleAdjustDtl.action',
	settleAdjustExcel:'payApplyFindSettleAdjustDtlExcel.action',
...
$(function() {
	// init Validator 
	$.formValidator.initConfig({ validatorgroup:"1", formid:"afForm", onerror : function(msg,obj) { 	alert(msg); $(obj).focus();} });
	
	$("#af_bankRealAmt").formValidator({validatorgroup:"1", onshow: "请输入实付金额"})
		.inputValidator({min:0,onerrormin:"实付金额必须填写", max:999999999999, onerrormax:'实付金额取值在0~999999999999',type:'value'}) /* 数字检查 */ 
	
	// afForm
	$('#afDiv').dialog({ autoOpen : false, bgiframe : true, modal : true, resizable : false, draggable : true, width : 600, height : 350
	, title: '付款申请单全部出账', buttons:{
		'出账' : function() {
			if($.formValidator.pageIsValid('1')) {
				$.ajaxForm({formId : 'afForm', url : urls.amtall,
				success : function(data) {
					if (data.success) { 
						$('#afDiv').dialog('close'); alert('操作成功'); $('#table').refresh();  
					} else { 
	...
	// amForm
	$('#amDiv').dialog({ autoOpen : false, bgiframe : true, modal : true, resizable : false, draggable : true, width : 600, height : 350
	, title: '付款申请单按商户出账', buttons:{
		'关闭' : function() { $(this).dialog('close'); }
	}});
	
	// amtForm
	$('#amtDiv').dialog({ autoOpen : false, bgiframe : true, modal : true, resizable : false, draggable : true, width : 600, height : 350
	, title: '付款申请单按商户出款', buttons:{
		'关闭' : function() { $(this).dialog('close'); }
	}});
	...
	// 按商户进行出帐
	var mchntapply = function(record,id) {
		if (!record) {alert("请选择一条记录"); return;}
		if ( record.payReqType != '01' ) { alert("仅商户付款单支持按商户进行出账"); return; }
		$('#am_version').val(record.version);
		$('#am_seqNo').val(record.seqNo);
		$('#am_queryBtn').click();
		$('#amDiv').dialog('open');
	};
	
	// 按商户进行出款
	var mchntamt = function(record,id) {
		if (!record) {alert("请选择一条记录"); return;}
		if ( record.payReqType != '01' ) { alert("仅商户付款单支持按商户进行出款"); return; }
		$('#amt_version').val(record.version);
		$('#amt_seqNo').val(record.seqNo);
		$('#amt_queryBtn').click();
		$('#amtDiv').dialog('open');
	};
	
	// 全部出款
	var allamt = function(record,id) {
		if (!record) {alert("请选择一条记录"); return;}
		$.jyform.resetForm('afForm');
		$.jyform.fillForm('afForm', record);
		if ( record.payReqType != '02' ) { alert("此功能服务商付款单专用,商户付款单请使用交易出款功能"); return; }
		$('#afDiv').dialog('open');
	}; 
	
	// 商户不出账
	var mchntPayRemove = function () {
		var vo = {version:  $('#am_version').val(), seqNo: $('#am_seqNo').val() };
		var mids = '';
		var data = $('#am_table').flexAllSelectData(); 
		$.each(data,function(i) { 
			if (i== 0) {mids = mids + this.mid} 
			else { mids = mids + ',' + this.mid}
		});
		if( mids == "" ){ alert("请选择一个商户"); return; }
		var remark = prompt('请输入不出账原因');
		$.ajax({url: urls.payApplyRemoveMchnt, type:'POST', dataType:'json', data:{jsonObject: $.toJSON(vo), mids: mids, remark: remark},  
		success : function(data) {
			if (data.success) { 
				$('#amDiv').dialog('close'); alert('操作成功'); $('#table').refresh();  
			} else { 
				alert('操作失败 原因是'+ data.syserr); 
			}
		}});
	...
	// 商户全部出帐
	var mchntPayAll = function(record,id) {
		var vo = {version:  $('#am_version').val(), seqNo: $('#am_seqNo').val() };
		if ( !confirm('是否将所有商户支付明细标记为出款中?此操作无法撤销') ) {
			return;
		}
		$.ajax({url: urls.payApplyAll, type:'POST', dataType:'json', data:{jsonObject: $.toJSON(vo)},  
		success : function(data) {
			if (data.success) { 
				alert('操作成功');
				$('#table').refresh();
				$('#am_table').refresh();
				$('#am_version').val(data.root[0].version);
				$('#am_seqNo').val(data.root[0].seqNo);
			} else { 
				alert('操作失败 原因是'+ data.syserr); 
			}
		}});
	...
	// 商户不出款
	var mchntAmtRemove = function () {
		var vo = {version:  $('#amt_version').val(), seqNo: $('#amt_seqNo').val() };
		var mids = '';
		var data = $('#amt_table').flexAllSelectData(); 
		$.each(data,function(i) { 
			if (i== 0) {mids = mids + this.mid} 
			else { mids = mids + ',' + this.mid}
		});
		if( mids == "" ){ alert("请选择一个商户"); return; }
		var remark = prompt('请输入出款失败原因');
		$.ajax({url: urls.payAmtFailedMchnt, type:'POST', dataType:'json', data:{jsonObject: $.toJSON(vo), mids: mids, remark: remark},  
		success : function(data) {
			if (data.success) { 
				$('#amtDiv').dialog('close'); alert('操作成功'); $('#table').refresh();  
			} else { 
				alert('操作失败 原因是'+ data.syserr); 
			}
		}});
	...
	// 商户全部出款
	var mchntAmtAll = function(record,id) {
		var vo = {version:  $('#amt_version').val(), seqNo: $('#amt_seqNo').val() };
		if ( !confirm('是否将所有商户支付明细标记为出款成功?此操作无法撤销') ) {
			return;
		}
		$.ajax({url: urls.payAmtSuccessAll, type:'POST', dataType:'json', data:{jsonObject: $.toJSON(vo)},  
		success : function(data) {
			if (data.success) { 
				alert('操作成功');
				$('#table').refresh();
				$('#amt_table').refresh();
				$('#amt_version').val(data.root[0].version);
				$('#amt_seqNo').val(data.root[0].seqNo);
			} else { 
				alert('操作失败 原因是'+ data.syserr); 
			}
		}});
	...
	var exportNetPay = function() {
		$.ajax({url: urls.exportNetPay, type:'POST', dataType:'json', data:{seqNo:$('#amt_seqNo').val()},  
			success : function(data) {
				if (data.success) { 
					alert('操作成功');
					$('#table').refresh();
	...
	$('#table').flexigrid({
		...
		buttons : [
		// {name: "商户出账", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit', id: 'txt', onpress : mchntamt },{separator : true }
		{name: "商户出账", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit',  id : 'cel',  onpress : mchntapply },{separator : true }
		,{name: "商户出款", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit',  id : 'cel',  onpress : mchntamt },{separator : true }
		,{name: "全部出账(服务商)", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit',  id : 'cel',  onpress : allamt },{separator : true }
		// ,{name: "填写备注信息", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit',  id : 'cel',  onpress : addRemark },{separator : true }
	...
	$('#mchntdtl_table').flexigrid({
		...
		colModel : [ 
       	...
       	,{ display: '是否延迟结算', dataIndex: 'delayStlmDesc', width: 80, align: 'center', sortable: true }
	...
	$('#am_table').flexigrid({
		url : urls.mchntdtl, height: 330, sort : 'mid', dir : "desc", checkbox : true, usepager : true, 
		buttons : [
			{name: "全部出帐", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit',  id : 'cel',  onpress : mchntPayAll },{separator : true }
		   ,{name: "不出账", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit',  id : 'cel',  onpress : mchntPayRemove },{separator : true }
		   ,{name: "导出", bclass: 'grid_excel',  id : 'excel',  onpress: function() { $('#am_table').flexFile(urls.mchntdtlExcel,{seqNo:$('#amt_seqNo').val()}); } }
		],
		colModel : [ 
   		 { display: '商户号', dataIndex: 'mid', width: 180, align: 'center', sortable: true }
   		,{ display: '商户名称', dataIndex: 'merName', width: 180, align: 'center', sortable: true }
   		,{ display: '交易笔数', dataIndex: 'stlmCount', width: 80, align: 'center', sortable: true}
   		,{ display: '交易金额', dataIndex: 'transAmt', width: 80, align: 'center', sortable: true, render:fmtMoney }
   		,{ display: '手续费', dataIndex: 'feeAmt', width: 80, align: 'center', sortable: true, render:fmtMoney }
   		,{ display: '清算金额', dataIndex: 'stlmAmt', width: 80, align: 'center', sortable: true, render:fmtMoney }
   		...
   		,{ display: '支行名', dataIndex: 'bankName', width: 80, align: 'center', sortable: true }
   		,{ display: '持卡人证件号', dataIndex: 'cardPersonNo', width: 80, align: 'center', sortable: true }
   		,{ display: '总行名', dataIndex: 'stlmCount', width: 80, align: 'center', sortable: true }
   		,{ display: '是否延迟结算', dataIndex: 'delayStlmDesc', width: 80, align: 'center', sortable: true }]
	});
	...
	$('#amt_table').flexigrid({
		url : urls.mchntdtl, height: 330, sort : 'mid', dir : "desc", checkbox : true, usepager : true, 
		buttons : [
			 {name: "全部出款", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit',  id : 'cel',  onpress : mchntAmtAll },{separator : true }
			,{name: "出款失败", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit',  id : 'cel',  onpress : mchntAmtRemove },{separator : true }
			,{name: "导出网银文件", show:'ROLE_FIN_PAYALY_ADD', bclass: 'grid_edit',  id : 'cel',  onpress : function() { $('#amt_table').flexFile(urls.exportNetPay,{reqSeqNo:$('#amt_seqNo').val()}); } },{separator : true }
		 	,{name: "导出", bclass: 'grid_excel',  id : 'excel',  onpress: function() { $('#amt_table').flexFile(urls.mchntdtlExcel,{seqNo:$('#amt_seqNo').val()}); } }
		],
		colModel : [ 
   		 { display: '商户号', dataIndex: 'mid', width: 180, align: 'center', sortable: true }
   		,{ display: '商户名称', dataIndex: 'merName', width: 180, align: 'center', sortable: true }
	...
	$('#am_queryBtn').click(function(){$.queryTable({formId : 'am_queryForm', tableId : 'am_table'});});
	$('#amt_queryBtn').click(function(){$.queryTable({formId : 'amt_queryForm', tableId : 'amt_table'});});
});
//-->
</script>
</body>