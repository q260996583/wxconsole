...
<script type="text/javascript"
	src="pagejs/console/business/outmer/qrcMerAdd.js"></script>
<style type="text/css">
.onShow {
	...
	<div id="queryCondition"
		...
		<form id="queryForm" name="queryForm" action="#" method="post"
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				<tr>
					<td class="qlabel">进件机构商户号</td>
					<td class="qinput"><input type="text" value="" comparison="like" qtype="string" name=addInstMerId size=20 /></td>
	...
	<div id="addMer" style="display: none;">
		<form id="form2">
			...
			<table class="ftable" cellpadding="1" cellspacing="1" width="100%">
				<tr>
					<td class="flabel" width="140px">机构号：</td>
					<td class="finput" width="310px"><input disabled id="a_instId"
						name="instId" maxLength="100" type="text"  value='000001' />
						<div id="a_instIdTip"></div></td>
						
					<!-- <td class="flabel" width="140px">机构商户号:</td>
				...
				<tr>
					<td class="flabel"><font color="red">*</font>商户手机号：</td>
				...
				<tr>
					...
					<td class="finput"><input id="a_merCardInfo" name="merCardInfo" maxLength="50"
						type="text"  />
				...
				<tr>
					<td class="flabel"><font color="red">*</font>商户银行卡联行信息：</td>
					<td class="finput"><input id="a_merCardBank" name="merCardBank"></input>
					<div id="a_merCardBankTip"></div></td>
					
					<td class="flabel"><font color="red">*</font>商户银行卡联行名字：</td>
				...
				<tr>
					...
					<td class="finput">
					<select id='a_merIdType' name='merIdType' style="width:100px " >
						<option ></option>
				...
				<tr>
					<td class="flabel"><font color="red">*</font>联系人姓名：</td>
	...
	<div id="editMer" style="display: none;">
		<form id="form3">
			...
			<table class="ftable" cellpadding="1" cellspacing="1" width="100%">
				...
				<tr>
					<td class="flabel" width="140px">进件商户机构号：</td>
					<td class="finput" width="310px"><input disabled id="b_addInstMerId"
						name="addInstMerId" maxLength="100" type="text"  />
						<div id="b_addInstMerIdTip"></div></td>
						<td></td>
						<td></td>
					<!-- <td class="flabel" width="140px">机构商户号:</td>
					<td class="finput" width="310px"><input disabled id="b_instMerId"
				...
				<tr>
					<td class="flabel"><font color="red">*</font>商户银行卡信息：</td>
					<td class="finput"><input id="b_merCardInfo" name="merCardInfo" maxLength="50"
						type="text" />
				...
				<tr>
					<td class="flabel"><font color="red">*</font>证件类型：</td>
					<td class="finput">
					<select id='b_merIdType' name='merIdType' style="width:100px " >
						<option value='01'>身份证</option>
    					<!-- <option value='02'>护照</option> -->
					</select>
				...
				<tr>
					...
					<td class="flabel"><font color="red">*</font>联系人类型：</td>
					<td class="finput">
					<select id='b_contactType' name='contactType' style="width:100px " >
						<option></option>
						<option value='00'>其他</option>
						<option value='01'>法人</option>
    					<option value='02'>实际控制人</option>
				...
				<tr id="shenpi">
	   				...
	   				<td class="fcontent">  <textarea class="qFormInput"  id="b_auditMemo" name="auditMemo" type="text" maxlength="300" ></textarea></td>
	  				<td></td>
	  				<td></td>
	  			</tr>
			</table>
