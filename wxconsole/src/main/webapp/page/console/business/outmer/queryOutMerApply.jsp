	...
	<div id="queryCondition"
		...
		<form id="queryForm" name="queryForm" action="#" method="post"
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				<tr>
					<td class="qlabel">起始日期</td>
					<td class="qinput"><input id="applyDateStart" name="applyDate" comparison="ge" /></td>
					<td class="qlabel">结束日期</td>
					<td class="qinput"><input id="applyDateEnd" name="applyDate" comparison="le" /></td>
					<td class="qlabel">商户名称</td>
					<td class="qinput"><input type="text" value="" comparison="like" qtype="string" name=merName size=20 /></td>
				</tr>
				<tr>
					<td class="qlabel">商户审批状态</td>
					<td class="qinput"><select id="status" name="status" comparison="eq"></select></td>
...
$('#table').flexigrid({url: 'findOutMerApply.action', width: 400, dir: "desc", sort: "orgCode", usepager: true, 
buttons: [
