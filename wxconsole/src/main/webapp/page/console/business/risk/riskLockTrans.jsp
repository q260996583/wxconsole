...
var urls = {
	add:'addRiskLockTrans.action',
	unlock:'unlockRiskLockTrans.action',
	listUnRel:'riskLockTransUnRelPage.action',
	addRel:'addRiskLockTransRel.action',
	delRel:'delRiskLockTransRel.action',
	list:'riskLockTransPage.action',
	excel:'riskLockTransPageExcel.action',
	listRel:'riskLockTransRelPage.action',
	excelRel:'riskLockTransRelPageExcel.action'
};
...
$(function() {
	...
	$("#a_remark").formValidator({validatorgroup:"1", onshow: "请填写延迟清算原因"})
	...
	$("#ul_unlock_remark").formValidator({validatorgroup:"2", onshow: "请填写解除延迟清算原因"})
	...
	, title: '风控交易延迟清算详情', buttons:{'关闭' : function() { $(this).dialog('close'); }
	}});
	
	// updRelForm
	$('#updRelDiv').dialog({ autoOpen : false, bgiframe : true, modal : true, resizable : false, draggable : true, width : 600, height : 450
	, title: '风控交易延迟清算交易配置', buttons:{'关闭' : function() { $(this).dialog('close'); }
	}});
	...
	$('#table').flexigrid({
		...
		buttons : [
			 //{name: "新增冻结", bclass: 'grid_add', id: 'txt', onpress : add },{separator : true }
			 {name: "解除延迟清算", show:'ROLE_RISK_TRANS_UNLOCK', bclass: 'grid_add', id: 'txt', onpress : unlock },{separator : true }
			//,{name: "配置关联交易", bclass: 'grid_add', id: 'txt', onpress : rel },{separator : true }
	...
	$('#ur_transrel_table').flexigrid({
		...
		buttons : [
			{name: "新增关联交易", bclass: 'grid_add', id: 'txt', onpress : addRel },{separator : true }
		   ,{name: "删除关联交易", bclass: 'grid_add', id: 'txt', onpress : delRel },{separator : true }
