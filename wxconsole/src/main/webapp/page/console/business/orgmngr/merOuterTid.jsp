...
<title>对外终端信息维护</title>
<jsp:include page="/js/jsall.jsp"></jsp:include>
<script type="text/javascript" src="pagejs/console/business/orgmngr/merOuterTid.js"></script>
</head>
<body>
...
<table class="ftable" cellpadding="1" cellspacing="1"  width="100%">
	<TBODY>
		<TR >
			<TD class="flabel"><FONT color=red>&nbsp;*</FONT>银行：</TD>
		...
		<TR >
			<TD class="flabel"><FONT color=red>&nbsp;*</FONT>外部终端号：</TD>
...
<table class="ftable" cellpadding="1" cellspacing="1"  width="100%">
	<TBODY>
		...
		<TR >
			<TD class="flabel">备注：</TD>
			<TD class="finput"><textarea  rows="4" cols="20" name="remark" maxLength=200 style="resize: none;"></textarea>
			<div id="remarkTip"></div>
			</TD>
		</TR>
	</TBODY>
