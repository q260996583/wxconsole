...
<title>商户定制报表信息</title>
<jsp:include page="/js/jsall.jsp"></jsp:include>
<script type="text/javascript"
	src="pagejs/console/business/orgmngr/mngrMerRepInfo.js"></script>
<style>
<!--
#mhtAttachInfoAddTbody .bt {
	width: 50px;
}
-->
</style>
...
<body>
				...
				<table class="ftable" cellpadding="1" cellspacing="1"
					...
					<TBODY>
						<tr>
							...
							<td class="fcontent"><input class="qFormInput" id="orgCode"
								name="orgCode" type="text" maxlength="20" readonly="readonly"
								disabled="disabled" /></td>
						</tr>
						<tr>
							<td class="flabel">商户名称:</td>
							<td class="fcontent"><input class="qFormInput" id="merName"
								name="merName" type="text" maxlength="100" /></td>
						</tr>
						<tr>
							<td class="flabel">商户对外经营名称:</td>
							<td class="fcontent"><input class="qFormInput"
								id="merOutName" name="merOutName" type="text" maxlength="100" /></td>
						</tr>
						<tr>
							<td class="flabel">商户英文名称:</td>
							<td class="fcontent"><input class="qFormInput" id="enName"
								name="enName" type="text" maxlength="100" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput" id="mcc"
								name="mcc" type="text" maxlength="50" /></td>
						</tr>
						<tr>
							<td class="flabel">地区代码:</td>
							<td class="fcontent"><input class="qFormInput"
								id="areaCodeZh" name="areaCodeZh" type="text" maxlength="50" /></td>
						</tr>
						<tr>
							<td class="flabel">营业执照统一社会信用代码:</td>
							<td class="fcontent"><input class="qFormInput"
								id="licenseNo" name="licenseNo" type="text" maxlength="15" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput"
								id="licenseAddr" name="licenseAddr" type="text" maxlength="15" /></td>
						</tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput"
								id="accntBankCodePrivate" name="accntBankCodePrivate"
								type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">企业成立日期:</td>
							<td class="fcontent"><input class="qFormInput"
								id="foundedDate" name="foundedDate" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">税务登记证号码:</td>
							<td class="fcontent"><input class="qFormInput" id="taxNo"
								name="taxNo" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">组织机构代码证:</td>
							<td class="fcontent"><input class="qFormInput" id="certNo"
								name="certNo" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">法人姓名:</td>
							<td class="fcontent"><input class="qFormInput"
								id="personName" name="personName" type="text" maxlength="15" /></td>
						<tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput" id="personNo"
								name="personNo" type="text" maxlength="20" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput" id="address"
								name="address" type="text" maxlength="15" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput" id="area"
								name="area" type="text" maxlength="15" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput" id="posNum"
								name="posNum" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">账户名称:</td>
							<td class="fcontent"><input class="qFormInput"
								id="accntName" name="accntName" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">账户号码:</td>
							<td class="fcontent"><input class="qFormInput" id="accntNo"
								name="accntNo" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">账户:</td>
							<td class="fcontent"><input class="qFormInput"
								id="bankTitle" name="bankTitle" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户账户类型:</td>
							<td class="fcontent"><input class="qFormInput"
								id="accntTypeZh" name="accntTypeZh" type="text" maxlength="15" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput"
								id="bankBranchNo" name="bankBranchNo" type="text" maxlength="15" /></td>
						</tr>
						<tr>
	    			...
	    			<td class="fcontent">  <input class="qFormInput" id="depositFlagZh" name="depositFlagZh" type="text" maxlength="15" /></td>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput"
								id="settlePeriod" name="settlePeriod" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">手续费收取类型:</td>
							<td class="fcontent"><input class="qFormInput"
								id="feeStlmTypeZh" name="feeStlmTypeZh" type="text"
								maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">手续费率(%):</td>
							<td class="fcontent"><input class="qFormInput" id="feeRate"
								name="feeRate" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">手续费固定值(元):</td>
							<td class="fcontent"><input class="qFormInput" id="feeVal"
								name="feeVal" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">手续费封顶值(元):</td>
							<td class="fcontent"><input class="qFormInput" id="topValue"
								name="topValue" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户联系人:</td>
							<td class="fcontent"><input class="qFormInput"
								id="merContact" name="merContact" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户传真:</td>
							<td class="fcontent"><input class="qFormInput" id="merFax"
								name="merFax" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户联系电话:</td>
							<td class="fcontent"><input class="qFormInput" id="merPhone"
								name="merPhone" type="text" maxlength="15" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput"
								id="merDevRate" name="merDevRate" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">外卡业务币种:</td>
							<td class="fcontent"><input class="qFormInput"
								id="outCardTypeZh" name="outCardTypeZh" type="text"
								maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">非借记卡单笔交易限额(元):</td>
							<td class="fcontent"><input class="qFormInput"
								id="tranLimit" name="tranLimit" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">借记卡单笔交易限额(元):</td>
							<td class="fcontent"><input class="qFormInput"
								id="tranLimitDebit" name="tranLimitDebit" type="text"
								maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户交易权限组:</td>
							<td class="fcontent"><input class="qFormInput"
								id="tranLimitParamZh" name="tranLimitParamZh" type="text"
								maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">接入模式:</td>
							<td class="fcontent"><input class="qFormInput"
								id="accessModeZh" name="accessModeZh" type="text" maxlength="15" /></td>
						</tr>

						<tr>
							<td class="flabel">商户信息录入人:</td>
							<td class="fcontent"><input class="qFormInput" id="oprAcc"
								name="oprAcc" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户信息录入时间:</td>
							<td class="fcontent"><input class="qFormInput"
								id="oprTimeDesc" name="oprTimeDesc" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">审批人:</td>
							<td class="fcontent"><input class="qFormInput" id="confAcc"
								name="confAcc" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">审批时间:</td>
							<td class="fcontent"><input class="qFormInput"
								id="confTimeDesc" name="confTimeDesc" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">审批意见:</td>
							<td class="fcontent"><input class="qFormInput" id="confRmk"
								name="confRmk" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户状态:</td>
							<td class="fcontent"><input class="qFormInput"
								id="merStatusZh" name="merStatusZh" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户注销时间:</td>
							<td class="fcontent"><input class="qFormInput" id="cnlTime"
								name="cnlTime" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户注销人:</td>
							<td class="fcontent"><input class="qFormInput" id="cnlAcc"
								name="cnlAcc" type="text" maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户启用时间:</td>
							<td class="fcontent"><input class="qFormInput"
								id="merStDateDesc" name="merStDateDesc" type="text"
								maxlength="15" /></td>
						</tr>
						<tr>
							<td class="flabel">商户审批状态:</td>
							<td class="fcontent"><input class="qFormInput"
								id="confStatusZh" name="confStatusZh" type="text" maxlength="15" /></td>
						</tr>
						<!-- 调单联系人 -->
						<tr>
						...
						<tr>
							...
							<td class="fcontent"><input class="qFormInput" id="remark"
								name="remark" type="text" maxlength="15" /></td>
						</tr>
					</TBODY>
				</table>
			</div>
		...
		<table class="ftable" cellpadding="1" cellspacing="1"
			...
			<tbody>
				<tr>
					...
					<td class="fcontent"><input class="qFormInput" id="bank_id"
						name="bank_id" type="text" maxlength="15" /></td>
				</tr>
				<tr>
					<td class="flabel">外部商户号:</td>
					<td class="fcontent"><input class="qFormInput" id="bankName"
						name="bankName" type="text" maxlength="64" /></td>
				</tr>
			</tbody>
		</table>
	</div>
			...
			<table class="ftable" cellpadding="1" cellspacing="1" width="100%">
				<TBODY>
					<TR>
						...
						<TD class="finput"><input class="qFormInput" name="orgCode"
							type="text" readonly="readonly" disabled="disabled" />
							<div id="brhIdTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel">描述：</TD>
						<TD class="finput"><textarea maxLength="200"
								id="channgeRemark" name="remark" rows="4" cols="20"></textarea>

						</TD>
					</TR>
					<TR>
						<TD class="flabel">商户状态：</TD>
						<TD class="finput"><input type="radio" id="result10"
							name="bussBrhStatus" value="02" />停用维护 <input type="radio"
							id="result20" name="bussBrhStatus" value="01" />正常启用
							<div id="bussBrhStatusTip"></div></TD>
					</TR>
				</TBODY>
			</table>
		...
		<form id="form5">
			<table class="ftable" cellpadding="1" cellspacing="1" width="100%">
				<TBODY>
					<TR>
						<TD class="flabel">商户编号：</TD>
						<TD class="finput"><input class="qFormInput" id="orgCode"
							name="orgCode" type="text" readonly="readonly"
							disabled="disabled" />
							<div id="brhIdTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel">商户名称：</TD>
						<TD class="finput"><input class="qFormInput" id="merName"
							name="merName" type="text" readonly="readonly"
							disabled="disabled" /></TD>
					</TR>
					<TR>
						<TD class="flabel">商户交易权限组：</TD>
						<TD class="finput"><select id="tranLimitParam"
							name="tranLimitParam" comparison="eq"></select></TD>
					</TR>
				</TBODY>
			</table>
			<input id="formreset" style="display: none;" type="reset" />
	...
	<div id="newMerRepInfo" style="display: none;">
		<form id="form1">
			<table class="ftable" cellpadding="1" cellspacing="1" width="100%">
				<TBODY>
					...
					<TR>
						...
						<TD class="finput"><INPUT id=bankTitle name=bankTitle>
							<div id="bankTitleTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel"><FONT color=red>&nbsp;*</FONT>商户编号：</TD>
						<TD class="finput"><INPUT id=bankName name=bankName>
							<div id="bankNameTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel"><FONT color=red>&nbsp;*</FONT>任务：</TD>
						<TD class="finput"><INPUT id=bankNo maxLength=15 name=bankNo>
							<div id="bankNoTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel"><FONT color=red>&nbsp;*</FONT>产品：</TD>
						<TD class="finput"><INPUT id=accntNo name=accntNo>
							<div id="accntNoTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel"><FONT color=red>&nbsp;*</FONT>交易状态：</TD>
						<TD class="finput"><INPUT id=accntName name=accntName>
							<div id="accntNameTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel"><FONT color=red>&nbsp;*</FONT>结算状态：</TD>
						<TD class="finput"><INPUT id=accntName name=accntName>
							<div id="accntNameTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel"><FONT color=red>&nbsp;*</FONT>文件类型：</TD>
						<TD class="finput"><INPUT id=accntName name=accntName>
							<div id="accntNameTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel"><FONT color=red>&nbsp;*</FONT>发送频率：</TD>
						<TD class="finput"><INPUT id=accntName name=accntName>
							<div id="accntNameTip"></div></TD>
					</TR>
					<TR>
						<TD class="flabel"><FONT color=red>&nbsp;*</FONT>发送方式：</TD>
						<TD class="finput"><INPUT id=accntName name=accntName>
							<div id="accntNameTip"></div></TD>
					</TR>
				</TBODY>
	...
	<tr>
		<td>{athTypeName}</td>
		<td>
			<input type="checkbox" readonly="readonly" class="athChecked"
					id="{athType}_checked" onclick="return false;" />
			<input type="hidden" id="ath_{athType}" athType="{athType}"
					class="athInMedSeq" />
			<input type="button" id="ath_{athType}_in_preview"
					class="bt preview-in-ath-btn" refNo="" fileId="ath_{athType}"
					athType="{athType}" value="查看" />
		</td>
		<td>
			<input type="checkbox" readonly="readonly" class="athCheckedUpd"
					id="{athType}_upd_checked" onclick="return false;" />
			<input type="hidden" id="ath_{athType}_upd" athType="{athType}"
					class="athUpdMedSeq" />
			<input type="button" class="bt upload-upd-ath-btn"
					fileId="ath_{athType}_upd" athType="{athType}"
					uploadMime="{athFileType}" value="上传" />
			<input type="button" id="ath_{athType}_upd_preview"
					class="bt preview-upd-ath-btn" refNo="" fileId="ath_{athType}_upd"
					athType="{athType}" value="查看" />
		</td>
	</tr>
</textarea>
