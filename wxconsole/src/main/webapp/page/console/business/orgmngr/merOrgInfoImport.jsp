...
<title>交易商户银行信息批量导入</title>
<jsp:include page="/js/jsall.jsp"></jsp:include>
<script type="text/javascript" src="pagejs/console/business/orgmngr/merOrgInfoImport.js"></script>
</head>
<body>
...
<table class="qtable" width="100%"  cellspacing="1" cellpadding="1" >
	<tr>
		...
		<td class="qinput"><input type="text"  comparison="like"
			qtype="string" name="cardAcceptName"  maxlength="100" /></td>	
