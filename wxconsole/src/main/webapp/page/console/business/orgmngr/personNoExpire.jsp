...
<body>
	<div id="queryCondition"
		...
		<form id="queryForm" name="queryForm" action="#" method="post"
			...
			<input type="hidden" id="h_personNoExpireDate" name="personNoExpireDate" comparison="le" qtype="string"/>
...
//									});
	...
	$('#merchantOutDetail').flexigrid({
		...
		$('#h_personNoExpireDate').val(theExDate);
		//初始化查询;
