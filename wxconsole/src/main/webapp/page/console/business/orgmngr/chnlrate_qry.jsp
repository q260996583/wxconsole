...
<html>
<head>
<title><f:message key="application.title" />服务商分润修改记录查询</title>
...
<div id="queryCondition">
	<form id="queryForm" name="queryForm" action="#" method="post">
		<ul class="qry-ul">
			...
			<li><label>状态</label><select id="q_status" name="status" multiple="multiple" ctype="CHNL_RATE_REC_STATUS" qtype="string" comparison="like"></select></li>
...
<div id="updtabs" style="border: none;">
	<ul>
   	...
   	<li id="tmpInfo"><a href="#updtabs-2">分润规则</a></li>
 	</ul>
 	<div id="updtabs-1">
		...
		<tr>
			...
			<td class="fcontent"><input class="cdnInput" id="u_statusDesc" name="statusDesc" type="text" readonly="readonly" /></td>
		</tr>
		<tr>
...
// <!--
var urls = {
	tmplist: 'findChnlRateTmpInQuery.action',
	list:'findChnlRateRec.action',
	excel:'findChnlRateRecExcel.action'
};
...
$(function() {
	...
	, title: '服务商分润修改记录查询', buttons:{'关闭' : function() { $(this).dialog('close'); }
	}});
	...
	// datagrid
	$('#table').flexigrid({
		url : urls.list, height: 330, sort: 'oprTime', dir: 'desc', checkbox : false, usepager : true, dbClickRecord: edit,
		buttons : [
		 {name: "查看详情", bclass: 'grid_edit',  id : 'cel',  onpress : edit },{separator : true }
		...
		,{ display: '状态', dataIndex: 'statusDesc', width: 120, align: 'center', sortable: true }
		]
	});
	...
	$('textarea[readonly=readonly]').css({'background':'#f2f2f2','border':'0'});
