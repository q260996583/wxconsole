...
<script type="text/javascript" src="pagejs/console/business/orgmngr/mngrMerAudit.js"></script>
<style type="text/css">
 .diffInfo19891028{
...
<div id="queryCondition"
		...
		<form id="queryForm" name="queryForm" action="#" method="post"
			...
			<input type="hidden" comparison="eq" qtype="stringlist" ftype="list"
						name="modiModule" value="00,01,03"/>
...
<tr>
	...
	<td><input id="wechatPayRate1" readonly="readonly" xtype="rate4" /></td>
	<td class="fcontent"><input class="qFormInput" id="wechatPayRate" name="wechatPayRate" type="text" xtype="rate4" readonly="readonly"/></td>
</tr>
<tr>
	<td class="flabel">外卡交易费率(%):</td>
	<td><input id="outCardRate1" readonly="readonly" xtype="rate4" /></td>
	<td class="fcontent"><input class="qFormInput" id="outCardRate" name="outCardRate" type="text" xtype="rate4" readonly="readonly"/></td>
</tr>
<tr>
	<td class="flabel">支付宝交易费率(%):</td>
	<td><input id="alipayPayRate1" readonly="readonly" xtype="rate4" /></td>
	<td class="fcontent"><input class="qFormInput" id="alipayPayRate" name="alipayPayRate" type="text" xtype="rate4" readonly="readonly"/></td>
</tr>
<!--wxb  -->
<tr>
	<td class="flabel">商户结算类别:</td>
	<td><input id="merStatementsType1" readonly="readonly" /></td>
	<td class="fcontent"><input class="qFormInput" id="merStatementsType" name="merStatementsType" type="text" readonly="readonly"/></td>
</tr>
<tr>
	<td class="flabel">垫资手续费费率(%):</td>
	<td><input id="merStatementsRate1" readonly="readonly" xtype="rate4" /></td>
	<td class="fcontent"><input class="qFormInput" id="merStatementsRate" name="merStatementsRate" type="text" xtype="rate4" readonly="readonly"/></td>
</tr>
<!-- 
