...
<body>
	<div id="queryCondition"
		...
		<form id="queryForm" name="queryForm" action="#" method="post"
			...
			<input type="hidden" id="h_bizLicnoExpireDate" name="bizLicnoExpireDate" comparison="le" qtype="string"/>
...
//									});
	...
	$('#merchantOutDetail').flexigrid({
		...
		$('#h_bizLicnoExpireDate').val(theExDate);
		//初始化查询;
