...
<script type="text/javascript" src="pagejs/console/business/trans/posTrans.js"></script>
</head>
		...
		<form id="queryForm" name="queryForm" action="#" method="post"
			...
			<table class="qtable" width="100%" cellspacing="1" cellpadding="1">
				...
				<tr>
					...
					<td class="qinput"><INPUT id="transSeq" name="transSeq" comparison="eq"></td>
					<td class="qlabel">终端交易流水</td>
					<td class="qinput"><INPUT id="tidSeq" name="tidSeq" comparison="eq"></td>
					<td class="qlabel">主帐号</td>
					<td class="qinput"><INPUT id="pan" name="panSearch" comparison="eq"></td>
					<td class="qlabel">交易状态</td>
					<td class="qinput"><select id="transSt" name="transSt" comparison="eq"></select></td>
				</tr>
				<tr>
					...
					<td class="qinput"><select id="transCode" name="transCode" comparison="eq"></select></td>
					<td class="qlabel">冲正标志</td>
					<td class="qinput"><select id="rollbackFlag" name="rollbackFlag" comparison="eq"></select></td>
					<td class="qlabel">撤销标志</td>
					<td class="qinput"><select id="cancelFlag" name="cancelFlag" comparison="eq"></select></td>
					<td class="qlabel">退货类型</td>
					<td class="qinput"><select id="backType" name="backType" comparison="eq"></select></td>
				</tr>
				<tr>
					<td class="qlabel">支付机构</td>
					<td class="qinput">
						<select id="transferPayorg" comparison="eq" name="transferPayorg"></select>
					</td>
					<td class="qlabel">结算类型</td>
					<td class="qinput"><select id="merStatementsType" name="merStatementsType" comparison="eq">
						<option></option>
						<option>T1</option>
						<option>D0</option>
					</select></td>
			...
			<table class="ftable" cellpadding="1" cellspacing="1" width="100%">
				<TBODY>
					...
					<TR>
						...
						<TD class="finput"><INPUT id="respCodeLocalZh" name="respCodeLocalZh" />
						</TD>
					</TR>
					<TR>
					...
					<TR>
						...
						<TD class="finput"><INPUT id="merStatementsType" name=merStatementsType></INPUT></TD>
					</TR>
					<TR>
					...
					<TR>
						...
						<TD class="finput"><INPUT id="backTypeDesc" name=backTypeDesc>
						</TD>
					</TR>
					<TR>
