...
<script type="text/javascript" src="pagejs/console/business/notice/conNoticeMngr.js"></script>
</head>
<body>
	...
	<tbody>
		...
		<tr >
			<td class="flabel">
				...
				<!-- <a id="a_contentEditBtn" class="bt" href="javascript:void(0);">HTML编辑</a> -->
				<a id="a_kindEditBtn" class="bt" href="javascript:void(0);">富文本编辑</a>
			</td>
		...
		<tr >
			...
			<td class="finput"><input type="text" id="startTime" name="startTime" xtype="datetime"/><div id="startTimeTip"></div>
			</td>
		</tr>
		<tr >
			<td class="flabel">失效时间：</td>
			<td class="finput"><input type="text" id="endTime" name="endTime" xtype="datetime"/><div id="endTimeTip"></div>
			</td>
		</tr>
		<tr>
			<td class="flabel">
			...
			<td class="finput"><input type="text" name="audUser" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			<td class="flabel">
			...
			<td class="finput"><input type="text" name="audTime" xtype="datetime" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			<td class="flabel">
			...
			<td class="finput"><textarea name="audRemark"  maxLength="400" readonly="readonly"></textarea>
			</td>
		</tr>
		<tr>
	...
	<tbody>
		...
		<tr >
			<td class="flabel">
				...
				<a id="v_kindPreviewBtn" class="bt" href="javascript:void(0);">富文本预览</a>
			</td>
			<td class="finput"><textarea type="text" id="v_content" name="content" ></textarea>
			</td>
		</tr>
		<tr >
			<td class="flabel">是否置顶：</td>
		...
		<tr>
			...
			<td class="finput"><input type="text" id="v_audUser" name="audUser" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			<td class="flabel">
		...
		<tr>
			...
			<td class="finput"><textarea id="v_audRemark" name="audRemark"  maxLength="400" readonly="readonly"></textarea>
			</td>
		</tr>
		<tr>
			<td class="flabel">公告目标操作员:</td>
