$(document).ready(function(){	
	...
	$('#querybutton').click(function(){
		...
		var href="findPayPosMerDetail.action?startDate="+startDate+"&endDate="+endDate+"&mid="+mid+"&merName="+encodeURI(encodeURI(qmerName));
	...
	$('#downFileExl').click(function(){
		...
		var href="findPayPosMerDetailExl.action?startDate="+startDate+"&endDate="+endDate+"&mid="+mid+"&merName="+encodeURI(encodeURI(qmerName));
		window.open(href);
	});	
