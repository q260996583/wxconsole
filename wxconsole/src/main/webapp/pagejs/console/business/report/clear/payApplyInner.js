$(document).ready(function(){	
	...
	$('#querybutton').click(function(){
		...
		var href="findPayApplyInner.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankId="+bankId;
	...
	$('#downFileExl').click(function(){
		...
		var href="findPayApplyInnerExl.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankId="+bankId+"&bankName="+encodeURI(encodeURI(bankName));		
		window.open(href);
	});	
