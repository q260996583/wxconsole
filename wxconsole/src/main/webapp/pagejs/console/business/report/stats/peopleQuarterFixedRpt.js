$(document).ready(function(){	
	...
	$('#querybutton').click(function(){
		...
		var href="findPeopleQuarterFixedRpt.action?startDate="+startDate+"&endDate="+endDate;
	...
	$('#downFileExl').click(function(){
		...
		var href="findPeopleQuarterFixedRptExl.action?startDate="+startDate+"&endDate="+endDate;
		window.open(href);
	});	
