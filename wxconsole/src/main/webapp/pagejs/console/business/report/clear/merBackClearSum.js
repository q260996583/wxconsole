$(document).ready(function(){
	...
	$('#querybutton').click(function(){
		...
		var href="findMerBackClearSum.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&mid="+mid+"&merName="+encodeURI(encodeURI(qmerName));
	...
	$('#downFileExl').click(function(){
		...
		var href="findMerBackClearSumExl.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&mid="+mid+"&merName="+encodeURI(encodeURI(qmerName));
		window.open(href);
	});	
