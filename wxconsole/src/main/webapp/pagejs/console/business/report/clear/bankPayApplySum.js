$(document).ready(function(){
	...
	$('#querybutton').click(function(){
		...
		var href="findBankPayApplySum.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankAccntId="+bankAccntId+"&bankId="+bankId;
	...
	$('#downFileExl').click(function(){
		...
		var href="findBankPayApplySumExl.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankAccntId="+bankAccntId+"&bankId="+bankId+"&bankName="+encodeURI(encodeURI(bankName));
		window.open(href);
	});	
