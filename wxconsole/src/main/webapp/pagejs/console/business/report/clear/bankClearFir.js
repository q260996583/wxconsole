$(document).ready(function(){	
	...
	$('#querybutton').click(function(){
		...
		var href="findBankClearFir.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankId="+bankId+"&bankName="+encodeURI(encodeURI(qbankName))+"&clearTransCode="+clearTransCode;
	...
	$('#downFileExl').click(function(){
		...
		var href="findBankClearFirExl.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankId="+bankId+"&bankName="+encodeURI(encodeURI(qbankName))+"&clearTransCode="+clearTransCode;
		window.open(href);
	});	
