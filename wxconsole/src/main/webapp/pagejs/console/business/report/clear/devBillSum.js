$(document).ready(function(){	
	...
	$('#querybutton').click(function(){
		...
		var href="findPosDevBillSum.action?dateStart="+dateStart+"&dateEnd="
		+dateEnd+"&mid="+mid+"&merName="+encodeURI(encodeURI(qmerName))
		+"&tid="+tid;
...
//		var channelCode=$('#channelCode').val();
		...
		var href="findPosDevBillSumExl.action?dateStart="+dateStart+
		"&dateEnd="+dateEnd+"&mid="+mid+"&merName="+encodeURI(encodeURI(qmerName))
		+"&tid="+tid;
		window.open(href);
	});	
