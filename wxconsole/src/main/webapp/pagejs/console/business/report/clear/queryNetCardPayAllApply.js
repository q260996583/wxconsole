$(document).ready(function(){	
	...
	$('#querybutton').click(function(){
		...
		var href="findNetCardPayApply.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankAccntId=17"+"&bankId="+bankId;
	...
	$('#downFile').click(function(){
		...
		window.open("exportfindNetCardPayApply.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankAccntId=17"+"&bankId="+bankId+"&bankName="+encodeURI(encodeURI(bankName)));
	...
	$('#downFileExl').click(function(){
		...
		var href="findNetCardPayApplyExl.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankAccntId=17"+"&bankId="+bankId+"&bankName="+encodeURI(encodeURI(bankName));
		window.open(href);
	});	
