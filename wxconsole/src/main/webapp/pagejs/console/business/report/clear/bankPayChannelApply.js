$(document).ready(function(){	
	...
	$('#querybutton').click(function(){
		...
		var href="findBankPayChannelApply.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankId="+bankId;
	...
	$('#downFile').click(function(){
		...
		window.open("exportBankPayChannelApplyFile.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankId="+bankId+"&bankName="+encodeURI(encodeURI(bankName)));
	...
	$('#downFileExl').click(function(){
		...
		var href="findBankPayChannelApplyExl.action?dateStart="+dateStart+"&dateEnd="+dateEnd+"&bankId="+bankId+"&bankName="+encodeURI(encodeURI(bankName));
		window.open(href);
	});	
