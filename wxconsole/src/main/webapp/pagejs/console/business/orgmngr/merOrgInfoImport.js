        ...
        $('#upfileform').dialog("option", "buttons", {
            '确定' : function() {
                ...
                if (isCon) {
                    ...
                    $.ajaxFileUpload({
                        url : 'doImportMerOrgInfoFile.action',
                        secureuri : false,
...
//                obj.askBatchNo = record.askBatchNo;
        ...
        colModel : [ {
            ...
            display : '外部标识码(32)',
            dataIndex : 'merOutAcquireInstitCode',
            align : 'center'
        }      
        , {
            ...
            dataIndex : 'sepcialchargeType',          
            align : 'center'
        },  {
            display : '特殊计费级别(银60.3.2）',
            dataIndex : 'sepcialchargeLevel',          
            align : 'center'
        },  {
