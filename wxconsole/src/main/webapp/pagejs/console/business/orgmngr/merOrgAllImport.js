        ...
        $('#upfileform').dialog("option", "buttons", {
            '确定' : function() {
                ...
                if (isCon) {
                    ...
                    $.ajaxFileUpload({
                        url : 'doImportMerOrgAllFile.action',
                        secureuri : false,
...
//                obj.askBatchNo = record.askBatchNo;
        ...
        colModel : [ {
            ...
            display : '外部标识码(32)',
            dataIndex : 'merOutAcqInst',
            align : 'center'
        }      
        , {
            display : '对银联的商户类别码（MCC）',
            dataIndex : 'mccCups',          
            align : 'center'
        }, {
            display : '受卡方名称(43)',
            ...
            display : '特殊计费类型(银60.3.1）',
            dataIndex : 'sepclachargeType',          
            align : 'center'
        },  {
            display : '特殊计费级别(银60.3.2）',
            dataIndex : 'sepclachargeLevel',          
            align : 'center'
        },  {
            display : '位商户扣率，值为扣率*10000(122.1)',
            dataIndex : 'busiDeductionRate',          
            align : 'center'
        },  {
            display : '最后更新时间',
            ...
            display : '最后更新账户',
            dataIndex : 'lastUpdAcc',          
            align : 'center'
        },  {
            display : '最后更新机构',
            dataIndex : 'lastUpdOrg',          
            align : 'center'
        }]
    });
