...
var debitRate1Tab = $('#debitRate1');
var debitMaxFee1Tab = $('#debitMaxFee1');
var creditRate1Tab = $('#creditRate1');
var mccGrpDesc1Tab = $('#mccGrpDesc1');
//lixl add 20161206 START
var wechatPayRate1Tab = $('#wechatPayRate1');
var outCardRate1Tab = $('#outCardRate1');
var alipayPayRate1Tab = $('#alipayPayRate1');
//lixl add 20161206 END
//wxb
var merStatementsRate1Tab = $('#merStatementsRate1');
var merStatementsType1Tab = $('#merStatementsType1');
...
var debitRateTab = $('#debitRate');
var debitMaxFeeTab = $('#debitMaxFee');
var creditRateTab = $('#creditRate');
var mccGrpDescTab = $('#mccGrpDesc');
//lixl add 20161206 START
var wechatPayRateTab = $('#wechatPayRate');
var outCardRateTab = $('#outCardRate');
var alipayPayRateTab = $('#alipayPayRate');
//lixl add 20161206 END
//wxb
var merStatementsRateTab = $('#merStatementsRate');
var merStatementsTypeTab = $('#merStatementsType');
//开户行网点编号
...
//		setStyle(brandFeeFlagZh1Tab,brandFeeFlagZhTab),
		setStyle(mccGrpDesc1Tab, mccGrpDescTab);
		setStyle(debitRate1Tab, debitRateTab);
		setStyle(debitMaxFee1Tab, debitMaxFeeTab);
		setStyle(creditRate1Tab, creditRateTab);
		setStyle(expectDateTab1, expectDateTab);
		//lixl 20161206 start
		setStyle(wechatPayRate1Tab, wechatPayRateTab);
		setStyle(outCardRate1Tab, outCardRateTab);
		setStyle(alipayPayRate1Tab, alipayPayRateTab);
		//lixl 20161206 end
		//wxb
		setStyle(merStatementsType1Tab, merStatementsTypeTab);
		setStyle(merStatementsRate1Tab, merStatementsRateTab);
...
//				ipFeeRate1Tab.val($.changeDecimalThree(parseFloat(data.root[0].ipFeeRate)));
				var oldMht = data.root[0];
				$.fillInput('mccGrpDesc1', oldMht.mccGrpDesc);
				$.fillInput('debitRate1', oldMht.debitRate);
				$.fillInput('debitMaxFee1', oldMht.debitMaxFee);
				$.fillInput('creditRate1', oldMht.creditRate);
				//20161206 start
				$.fillInput('wechatPayRate1', oldMht.wechatPayRate);
				$.fillInput('outCardRate1', oldMht.outCardRate);
				$.fillInput('alipayPayRate1', oldMht.alipayPayRate);
				//wxb
				$.fillInput('merStatementsType1', oldMht.merStatementsType);
				$.fillInput('merStatementsRate1', oldMht.merStatementsRate);
			}else{
